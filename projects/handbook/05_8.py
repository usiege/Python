...
from sklearn.ensemble import RandomForestRegressor  # 全体
...
# %%
# helpers_05_08.py
# (https: // github.com/jakevdp/PythonDataScienceHandbook/helpers_05_08.py)
# import helpers_05_08
...
def model(x, sigma=0.3):
    ...
    slow_oscillation = np.sin(0.5 * x)  # 振荡
